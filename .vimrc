...
Plugin 'zchee/deoplete-jedi'                " jedi for Deoplete

"-------------------=== Other ===-------------------------------
Plugin 'mattn/emmet-vim'                    " Emmet snippet support
Plugin 'tpope/vim-surround'                 " Parentheses, brackets, quotes, XML tags, and more
Plugin 'flazz/vim-colorschemes'             " Colorschemes
Plugin 'vimwiki/vimwiki'                    " Personal Wiki
Plugin 'jreybert/vimagit'                   " Git Operations
Plugin 'tpope/vim-fugitive'                 " Git buffer support
Plugin 'airblade/vim-gitgutter'             " Gitgutter by line numbers
...
"-------------------=== LaTeX ===-------------------------------
Plugin 'thomashn/Vim-ShareLaTeX-Plugin'     " Plugin to load ShareLaTeX projects
...
colorscheme ubaryd
let g:airline_theme='base16_eighties'             " set airline theme
...
nnoremap <C-k> <C-w>k
nnoremap <C-l> <C-w>l
inoremap jk <Esc>                           " use jk instead of Esc to leave I-Mode
...
"" LaTeX settings
"=====================================================
let g:sharelatex_email='theo.j.cole@gmail.com'
let g:sharelatex_password='__21-stay-SILENT-various-47__'
"
"=====================================================
"" Python settings
"=====================================================
...
augroup vimrc_autocmds
    ...
    autocmd FileType python,rst,c,cpp match Excess /\%81.*/
